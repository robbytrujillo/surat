...
{{--  </a>  --}}
        ...
        <a href="{{ route('user.index') }}" class="button" style="text-decoration: none; padding: 10px 20px; background-color: #dee4ea; color: rgb(25, 24, 24); border-radius: 30px; display: inline-block;">Kembali</a>
                ...
                <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" id="role" class="form-control">
                            ...
                            <option {{ $user->role == 'penandatangan' ?  'selected' : '' }} value="penandatangan">Penandatangan</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($user->tanda_tangan)
                            <img src="{{ asset($user->tanda_tangan) }}" alt="ttd" height="50" class="mb-3">
                        @endif
                        <input type="file" 
                            name="tanda_tangan" 
                            class="form-control @error('tanda_tangan') is-invalid @enderror"
                            value="{{ old('tanda_tangan', $user->tanda_tangan) }}"
